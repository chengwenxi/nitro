...
func (con MtDebug) Events(c ctx, evm mech, paid huge, flag bool, value bytes32) (addr, huge, error) {
...
func (con MtDebug) CustomRevert(c ctx, number uint64) error {
	return con.CustomError(number, "This spider family wards off bugs: /\\oo/\\ //\\(oo)/\\ /\\oo/\\", true)
}

// Caller becomes a chain owner
func (con MtDebug) BecomeChainOwner(c ctx, evm mech) error {
