...
use crate::{
    gostack::GoRuntimeState, mtcompress, runtime, socket, syscall, syscall::JsRuntimeState, wavmio,
    wavmio::Bytes32, Opts,
};
...
pub fn create(opts: &Opts, env: WasmEnvArc) -> (Instance, WasmEnvArc) {
    ...
    let imports = imports! {
        "go" => {
            ...
            "github.com/mantlenetworkio/mantle/wavmio.getGlobalStateBytes32" => func!(wavmio::get_global_state_bytes32),
            "github.com/mantlenetworkio/mantle/wavmio.setGlobalStateBytes32" => func!(wavmio::set_global_state_bytes32),
            "github.com/mantlenetworkio/mantle/wavmio.getGlobalStateU64" => func!(wavmio::get_global_state_u64),
            "github.com/mantlenetworkio/mantle/wavmio.setGlobalStateU64" => func!(wavmio::set_global_state_u64),
            "github.com/mantlenetworkio/mantle/wavmio.readInboxMessage" => func!(wavmio::read_inbox_message),
            "github.com/mantlenetworkio/mantle/wavmio.readDelayedInboxMessage" => func!(wavmio::read_delayed_inbox_message),
            "github.com/mantlenetworkio/mantle/wavmio.resolvePreImage" => func!(wavmio::resolve_preimage),

            "github.com/mantlenetworkio/mantle/mtcompress.brotliCompress" => func!(mtcompress::brotli_compress),
            "github.com/mantlenetworkio/mantle/mtcompress.brotliDecompress" => func!(mtcompress::brotli_decompress),
        },
    };
