...
impl Memory {
    ...
    pub fn get_value(&self, idx: u64, ty: MtValueType, bytes: u8, signed: bool) -> Option<Value> {
        ...
        Some(match ty {
            MtValueType::I32 => Value::I32(contents as u32),
            MtValueType::I64 => Value::I64(contents as u64),
            MtValueType::F32 => {
