...
func NewDelayedBridge(client mtutil.L1Interface, addr common.Address, fromBlock uint64) (*DelayedBridge, error) {
...
func (m *DelayedInboxMessage) AfterInboxAcc() common.Hash {
	hash := crypto.Keccak256(
		...
		mtmath.UintToBytes(m.Message.Header.BlockNumber),
		mtmath.UintToBytes(m.Message.Header.Timestamp),
