...
func NewSequencerInbox(client mtutil.L1Interface, addr common.Address, fromBlock int64) (*SequencerInbox, error) {
...
func (m *SequencerInboxBatch) GetData(ctx context.Context, client mtutil.L1Interface) ([]byte, error) {
...
func (m *SequencerInboxBatch) Serialize(ctx context.Context, client mtutil.L1Interface) ([]byte, error) {
	if m.serialized != nil {
