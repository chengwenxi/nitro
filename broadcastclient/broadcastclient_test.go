...
func TestReceiveMessages(t *testing.T) {
	...
	go func() {
		for i := 0; i < messageCount; i++ {
			Require(t, b.BroadcastSingle(mtstate.TestMessageWithMetadataAndRequestId, mtutil.MessageIndex(i)))
		}
	}()
...
func newTestBroadcastClient(config Config, listenerAddress net.Addr, chainId uint64, currentMessageCount mtutil.MessageIndex, txStreamer TransactionStreamerInterface, feedErrChan chan error, validAddr *common.Address) *BroadcastClient {
...
func TestServerClientDisconnect(t *testing.T) {
	...
	Require(t, b.BroadcastSingle(mtstate.EmptyTestMessageWithMetadata, 0))
...
func TestBroadcasterSendsCachedMessagesOnClientConnect(t *testing.T) {
	...
	*/
	...
	Require(t, b.BroadcastSingle(mtstate.EmptyTestMessageWithMetadata, 0))
	Require(t, b.BroadcastSingle(mtstate.EmptyTestMessageWithMetadata, 1))
