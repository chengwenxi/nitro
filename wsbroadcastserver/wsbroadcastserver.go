...
const (
	HTTPHeaderFeedServerVersion       = "Mantle-Feed-Server-Version"
	HTTPHeaderFeedClientVersion       = "Mantle-Feed-Client-Version"
	HTTPHeaderRequestedSequenceNumber = "Mantle-Requested-Sequence-Number"
	HTTPHeaderChainId                 = "Mantle-Chain-Id"
	FeedServerVersion                 = 2
	FeedClientVersion                 = 2
)
