...
interface MtGasInfo {
    ...
    /// @notice Get MtOS's estimate of the L1 basefee in wei
    function getL1BaseFeeEstimate() external view returns (uint256);

    /// @notice Get how slowly MtOS updates its estimate of the L1 basefee
    ...
    /// @notice Get how slowly MtOS updates the L2 basefee in response to backlogged gas
    function getPricingInertia() external view returns (uint64);

    /// @notice Get the forgivable amount of backlogged gas MtOS will ignore when raising the basefee
