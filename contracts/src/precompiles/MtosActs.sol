...
/*
 * Copyright 2020, Mantlenetwork, Inc.
 *
...
/**
 * @title This precompile represents MtOS's internal actions as calls it makes to itself
 * @notice Calling this precompile will always revert and should not be done.
 */
interface MtosActs {
    /**
     * @notice MtOS "calls" this when starting a block
